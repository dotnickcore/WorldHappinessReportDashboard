...
layout = html.Div([
    ...
    dcc.Graph(id="least-happiest-chart"),
])

@app.callback(
    Output("least-happiest-chart", "figure"), 
    [Input("dropdown", "value")])

def update_bar_chart(year):
    if year == 2015:
        df_top20 = df_2015[-10:].sort_values('Happiness Score', ascending = True)
        fig = px.bar(df_top20, x='Happiness Score', y='Country',orientation='h',title="Top 10 Least Happiest Countries (2015)")
    elif year == 2016:
        df_top20 = df_2016[-10:].sort_values('Happiness Score', ascending = True)
        fig = px.bar(df_top20, x='Happiness Score', y='Country',orientation='h',title="Top 10 Least Happiest Countries (2016)")
    elif year == 2017:
        df_top20 = df_2017[-10:].sort_values('Happiness Score', ascending = True)
        fig = px.bar(df_top20, x='Happiness Score', y='Country',orientation='h',title="Top 10 Least Happiest Countries (2017)")
    elif year == 2018:
        df_top20 = df_2018[-10:].sort_values('Happiness Score', ascending = True)
        fig = px.bar(df_top20, x='Happiness Score', y='Country',orientation='h',title="Top 10 Least Happiest Countries (2018)")
    elif year == 2019:
        df_top20 = df_2019[-10:].sort_values('Happiness Score', ascending = True)
        fig = px.bar(df_top20, x='Happiness Score', y='Country',orientation='h',title="Top 10 Least Happiest Countries (2019)")
    elif year == 2020:
        df_top20 = df_2020[-10:].sort_values('Happiness Score', ascending = True)
        fig = px.bar(df_top20, x='Happiness Score', y='Country',orientation='h',title="Top 10 Least Happiest Countries (2020)")
