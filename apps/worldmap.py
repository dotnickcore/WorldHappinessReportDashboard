...
layout = html.Div([
    html.Div([
        ...
        dbc.Container([
            dbc.Row([
                dbc.Col(html.Li(children="Countries highlighted in dark green are the happier countries, countries that are green are countries that are not the happiest countries or the most unhappiest countries, and any country highlight with a lighter green are the least happiest countries."), className="mb-2")
            ])
        ])
    ]),
])
...
# returns the map with stats depending on the year.
def update_worldmap(year):
    if year == 2015:
        fig = px.choropleth(df_2015, locations=df_2015['Country'],
        ...
        fig = px.choropleth(df_2016, locations=df_2016['Country'],
                    locationmode = 'country names',
                    color='Happiness Score',
                    hover_name="Country",
                    color_continuous_scale=px.colors.sequential.YlGn,
        ...
        fig = px.choropleth(df_2017, locations=df_2017['Country'],
                    locationmode = 'country names',
                    color='Happiness Score',
                    hover_name="Country",
                    color_continuous_scale=px.colors.sequential.YlGn,
        ...
        fig = px.choropleth(df_2018, locations=df_2018['Country'],
                    locationmode = 'country names',
                    color='Happiness Score',
                    hover_name="Country",
                    color_continuous_scale=px.colors.sequential.YlGn,
        ...
        fig = px.choropleth(df_2019, locations=df_2019['Country'],
                    locationmode = 'country names',
                    color='Happiness Score',
                    hover_name="Country",
                    color_continuous_scale=px.colors.sequential.YlGn,
        ...
        fig = px.choropleth(df_2020, locations=df_2020['Country'],
                    locationmode = 'country names',
                    color='Happiness Score',
                    hover_name="Country",
                    color_continuous_scale=px.colors.sequential.YlGn,
