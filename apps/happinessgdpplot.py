...
layout = html.Div([
    html.Div([
        ...
        dcc.Graph(id="happiness-gdp-graph"),
        ]),
        dbc.Container([
            dbc.Row([
...
@app.callback(
    Output("happiness-gdp-graph", "figure"), 
    [Input("dropdown", "value")])

def update_scatter_chart(year):
    if year == 2015:
        fig = px.scatter(df_2015, x='Economy (GDP per Capita)', y='Happiness Score', hover_name ="Country", trendline="lowess")
    elif year == 2016:
        fig = px.scatter(df_2016, x='Economy (GDP per Capita)', y='Happiness Score', hover_name ="Country", trendline="lowess")
    elif year == 2017:
        fig = px.scatter(df_2017, x='Economy (GDP per Capita)', y='Happiness Score', hover_name ="Country", trendline="lowess") 
    elif year == 2018:
        fig = px.scatter(df_2018, x='Economy (GDP per Capita)', y='Happiness Score', hover_name ="Country", trendline="lowess") 
    elif year == 2019:
        fig = px.scatter(df_2019, x='Economy (GDP per Capita)', y='Happiness Score', hover_name ="Country", trendline="lowess")
    elif year == 2020:
        fig = px.scatter(df_2020, x='Economy (GDP per Capita)', y='Happiness Score', hover_name ="Country", trendline="lowess")
