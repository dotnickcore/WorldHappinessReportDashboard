...
layout = html.Div([
    html.Div([
        ...
        dcc.Graph(id="happiness-generosity-graph"),
        ]),
        dbc.Container([
            dbc.Row([
                dbc.Col(html.Li(children="Surprisingly, generosity has mixed results. Some countries are became least generous overtime."), className="mb-2")
            ])
        ])
    ]),
])
...
@app.callback(
    Output("happiness-generosity-graph", "figure"), 
    [Input("dropdown", "value")])

def update_scatter_chart(year):
    if year == 2015:
        fig = px.scatter(df_2015, x='Generosity', y='Happiness Score', hover_name ="Country", trendline="lowess")
    elif year == 2016:
        fig = px.scatter(df_2016, x='Generosity', y='Happiness Score', hover_name ="Country", trendline="lowess")
    elif year == 2017:
        fig = px.scatter(df_2017, x='Generosity', y='Happiness Score', hover_name ="Country", trendline="lowess") 
    elif year == 2018:
        fig = px.scatter(df_2018, x='Generosity', y='Happiness Score', hover_name ="Country", trendline="lowess") 
    elif year == 2019:
        fig = px.scatter(df_2019, x='Generosity', y='Happiness Score', hover_name ="Country", trendline="lowess")
    elif year == 2020:
        fig = px.scatter(df_2020, x='Generosity', y='Happiness Score', hover_name ="Country", trendline="lowess")
